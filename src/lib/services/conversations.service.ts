...
export async function getConversations(client: Client, userId: string): Promise<Conversation[]> {
	...
	return (
		members
			...
			// Use Date.parse() instead of new Date() to avoid memory allocations during sort comparisons
